      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-shadow">
            ...
            {features.map((feature, index) => {
              ...
              return (
                <li key={index} className="flex items-center gap-3">
                  ...
                  <span
                    className={`text-sm ${!isBoolean || value ? "text-gray-700 dark:text-gray-300" : "text-gray-400 dark:text-gray-600"}`}
                  >
                    {feature.name}
                    {!isBoolean && value && (
          ...
          <Link href="/sign-up" className="block">
            <Button
              variant="outline"
              className="w-full border-2 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 hover:border-gray-400 dark:hover:border-gray-500 transition-all py-6 text-base font-semibold"
            >
              Get Started Free
            </Button>
          </Link>
        ...
        <div className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-purple-700 rounded-2xl p-8 shadow-2xl overflow-hidden">
          ...
          <div className="relative text-center mb-6">
            ...
            <p className="text-blue-100">Full access with priority support</p>
          </div>
